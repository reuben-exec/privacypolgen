...
// Shared output rendering for Privacy Policy, T&C, and Cookie Policy.
// Displays format tabs (Markdown | HTML | Plain Text) with copy, PDF, DOCX exports.
...
interface DocumentViewProps {
  ...
  hash: string;
  generatedAt: string;
  /** Key prefix for i18n lookups (e.g. "policyView", "termsView", "cookieView") */
  i18nPrefix?: string;
}
...
export function DocumentView({
  ...
  const prettyHtml = useSafeHtml(html, theme, locale, title);
...
function useSafeHtml(html: string, theme: 'dark' | 'light', locale: string, _title: string): string {
